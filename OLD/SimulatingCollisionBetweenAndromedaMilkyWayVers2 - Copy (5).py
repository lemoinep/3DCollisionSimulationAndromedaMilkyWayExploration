...
# --- Galaxies satellites majeures de la Voie Lactée ---
satellite_params = [
    # nom,        Mvis,    Mdark,    pos_x, pos_y, pos_z,   vel_x, vel_y, vel_z, n_stars, radius, color,  incl_deg, incl_axis
...
ax.set_ylabel('Y [kpc]')
ax.set_zlabel('Z [kpc]')
ax.set_title("Simulation : Groupe Local et satellites de la Voie Lactée")
...
scatters = [
    ...
    for col, lab in zip(main_colors, ['Andromède', 'Voie Lactée', 'LMC', 'SMC', 'M33'])
]
scatters += [
